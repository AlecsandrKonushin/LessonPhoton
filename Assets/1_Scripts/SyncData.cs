...
public class SyncData
{
    ...
    public static object Deserialize(byte[] bytes)
    {
        ...
        int width = MapController.Instance.GetWidth;
        int height = MapController.Instance.GetHeight;

        int players = (bytes.Length - width * height / 8) / 12;
        ...
        byte[] mapBytes = new byte[width * height / 8];
